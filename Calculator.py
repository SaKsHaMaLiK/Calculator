...
clear = Button(root, text="C", width=2, command=clear,
               bg="skyblue", fg="white", relief=RIDGE)
...
seven = Button(root, text="7", width=2, command=seven,
               borderwidth=3, relief=RIDGE)
seven.grid(row=1, sticky="w", padx=75)

plus = Button(root, text="+", width=2, command=plus,
              borderwidth=3, relief=RIDGE)
...
four = Button(root, text="4", width=2, command=four,
              borderwidth=3, relief=RIDGE)
four.grid(row=2, sticky="w", padx=75, pady=5)

minus = Button(root, text="-", width=2, command=minus,
               borderwidth=3, relief=RIDGE)
...
multiply = Button(root, text="*", width=2, command=mul,
                  borderwidth=3, relief=RIDGE)
...
double_zero = Button(text="00", width=2, command=double_zero,
                     borderwidth=3, relief=RIDGE)
...
divide = Button(root, text="/", width=2, command=divide,
                borderwidth=3, relief=RIDGE)
divide.grid(row=4, sticky="e", padx=125, pady=5)

result = Button(root, text="=", width=10, command=result,
                bg="skyblue", fg="white", borderwidth=3, relief=RIDGE)
